...
export const SITE_FAQ: FaqItem[] = [
  {
    ...
    answer:
      "Quantex AI Solutions is a Beirut-based studio founded in 2024. We design and build custom software, high-converting websites, AI chatbots, business process automation, system architecture, and technical SEO for businesses in Lebanon and internationally.",
  },
  {
    question: "Who founded Quantex AI Solutions?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Core services include custom software development, business process automation, custom system architectures, high-converting websites, SEO, and custom intelligent chatbots integrated with tools like WhatsApp and internal dashboards.",
  },
  {
